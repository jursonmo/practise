...
// asavie/xdp 原有的example
////go:generate $HOME/go/bin/bpf2go fast_l2fwd fast_l2fwd.c -- -I/usr/include/ -I./include -nostdinc -O3

// 仿造xconnect
//go:generate bpf2go -target bpf fast_l2fwd ../../cmd/xdp_learn/ebpf/fast_l2fwd.c -- -I/root/goworkspace/practise/cmd/xdp_learn/ebpf/include -O2 -Wall
